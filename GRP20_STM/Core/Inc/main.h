...
#define INIT_DUTY_SP1_L 2700
#define INIT_DUTY_SP1_R 2700
#define DUTY_SP1_RANGE 700

#define INIT_DUTY_SP2_L 4000 //3300
#define INIT_DUTY_SP2_R 4000 //3300
#define DUTY_SP2_RANGE 700 //700
...
//////////////// ENCODER  ////////////////
#define __GET_TARGETTICK(dist, targetTick) ({ \
	targetTick = (((dist) * 0.1212885154) / WHEEL_LENGTH * 13120) - 10; \
})

#define __GET_DISTANCE(targetTick, targetDist) ({ \
		targetDist = (WHEEL_LENGTH) * (targetTick + 10) / ((0.1212885154) * 13120); \
})
